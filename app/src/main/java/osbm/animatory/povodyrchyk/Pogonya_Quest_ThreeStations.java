...
public class Pogonya_Quest_ThreeStations extends AppCompatActivity implements Places {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pogonya_quest_threestations);
        OpenNextPlace();
    }

    public void OpenNextPlace() {
        ButtonShow = (Button) findViewById(R.id.ThreeStationsButtonNext);
        MagicWord = (EditText) findViewById(R.id.ThreeStationsLine);
        ...
        ButtonShow.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        else if (Places[6].equals(String.valueOf(MagicWord.getText()))) {
                            openSixthPlace();
                        }
