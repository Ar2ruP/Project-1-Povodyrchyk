...
public class Pogonya_Quest_Mari_Start extends AppCompatActivity implements Places{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pogonya_quest_mari_start);
        OpenNextPlace();
    }

    public void OpenNextPlace() {
        ButtonShow = (Button) findViewById(R.id.MeriButtonNext);
        MagicWord = (EditText) findViewById(R.id.MeriLine);
