...
public class Pogonya_Quest_Cemeteru extends AppCompatActivity implements Places {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pogonya_quest_cemeteru);
        OpenNextPlace();
    }

    public void OpenNextPlace() {
        ButtonShow = (Button) findViewById(R.id.CemeteruButtonNext);
        MagicWord = (EditText) findViewById(R.id.CemeteruLine);
