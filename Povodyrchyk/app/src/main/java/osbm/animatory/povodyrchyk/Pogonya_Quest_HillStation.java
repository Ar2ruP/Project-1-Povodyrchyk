...
public class Pogonya_Quest_HillStation extends AppCompatActivity implements Places {
    private Button ButtonShow;
    private EditText MagicWord;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pogonya_quest_hillstation);
        OpenNextPlace();
    }
    public void OpenNextPlace() {
        ButtonShow = (Button) findViewById(R.id.HillStationButtonNext);
        MagicWord = (EditText) findViewById(R.id.HillStationLine);
