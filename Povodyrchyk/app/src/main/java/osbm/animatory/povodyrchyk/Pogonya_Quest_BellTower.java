...
public class Pogonya_Quest_BellTower extends AppCompatActivity implements Places {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pogonya_quest_belltower);
        OpenNextPlace();
    }

    public void OpenNextPlace() {
        ButtonShow = (Button) findViewById(R.id.BellTowerButton);
        MagicWord = (EditText) findViewById(R.id.BellTowerLine);
