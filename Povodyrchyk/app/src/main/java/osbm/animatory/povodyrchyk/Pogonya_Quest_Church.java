...
public class Pogonya_Quest_Church extends AppCompatActivity implements Places {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pogonya_quest_church);
        OpenNextPlace();
    }

    public void OpenNextPlace() {
        ButtonShow = (Button) findViewById(R.id.ChurchButtonNext);
        MagicWord = (EditText) findViewById(R.id.ChurchLine);
