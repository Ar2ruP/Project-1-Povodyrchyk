...
public class Pogonya_Quest_RefectoryChurch extends AppCompatActivity implements Places{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pogonya_quest_refectorychurch);
        OpenNextPlace();
    }
    public void OpenNextPlace() {
        ButtonShow = (Button) findViewById(R.id.RefectoryChurchButtonNext);
        MagicWord = (EditText) findViewById(R.id.RefectoryChurchLine);
        ...
        ButtonShow.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (Places[4].equals(String.valueOf(MagicWord.getText()))) {
                            openFourthPlace();
                        }
