...
public class Pogonya_Quest_BusStation extends AppCompatActivity implements Places {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pogonya_quest_busstation);
        OpenNextPlace();
    }

    public void OpenNextPlace() {
        ButtonShow = (Button) findViewById(R.id.BusStationButtonNext);
        MagicWord = (EditText) findViewById(R.id.BusStationLine);
